      ...
      >
        ...
        <div className="flex flex-1 flex-col overflow-hidden md:flex-row">
          <nav className="flex max-h-28 shrink-0 gap-2 overflow-x-auto overflow-y-hidden border-b border-ops-border/20 bg-ops-deep/40 p-3 md:max-h-none md:w-[220px] md:flex-col md:overflow-x-hidden md:overflow-y-auto md:border-b-0 md:border-r md:p-4" aria-label={t('settings.navigation')}>
            <button type="button" className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 text-[11px] font-bold  active:scale-[0.98] ${activeSection === 'appearance' ? 'bg-ops-green/15 text-ops-green shadow-glow border border-ops-green/30' : 'text-ops-muted hover:text-ops-text hover:bg-ops-panel/60 border border-transparent'}`} onClick={() => setActiveSection('appearance')}>{t('settings.appearance')}</button>
            <button type="button" className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 text-[11px] font-bold  active:scale-[0.98] ${activeSection === 'groups' ? 'bg-ops-green/15 text-ops-green shadow-glow border border-ops-green/30' : 'text-ops-muted hover:text-ops-text hover:bg-ops-panel/60 border border-transparent'}`} onClick={() => setActiveSection('groups')}>{t('settings.groups')}</button>
            <button type="button" className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 text-[11px] font-bold  active:scale-[0.98] ${activeSection === 'models' ? 'bg-ops-green/15 text-ops-green shadow-glow border border-ops-green/30' : 'text-ops-muted hover:text-ops-text hover:bg-ops-panel/60 border border-transparent'}`} onClick={() => setActiveSection('models')}>{t('settings.models')}</button>
            <button type="button" className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 text-[11px] font-bold  active:scale-[0.98] ${activeSection === 'sshKeys' ? 'bg-ops-green/15 text-ops-green shadow-glow border border-ops-green/30' : 'text-ops-muted hover:text-ops-text hover:bg-ops-panel/60 border border-transparent'}`} onClick={() => setActiveSection('sshKeys')}>{t('settings.sshKeys')}</button>
            <button type="button" className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 text-[11px] font-bold  active:scale-[0.98] ${activeSection === 'permissions' ? 'bg-ops-green/15 text-ops-green shadow-glow border border-ops-green/30' : 'text-ops-muted hover:text-ops-text hover:bg-ops-panel/60 border border-transparent'}`} onClick={() => setActiveSection('permissions')}>{t('settings.permissions')}</button>
            <button type="button" className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 text-[11px] font-bold  active:scale-[0.98] ${activeSection === 'skills' ? 'bg-ops-green/15 text-ops-green shadow-glow border border-ops-green/30' : 'text-ops-muted hover:text-ops-text hover:bg-ops-panel/60 border border-transparent'}`} onClick={() => setActiveSection('skills')}>{t('settings.skills')}</button>
            <button type="button" className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 text-[11px] font-bold  active:scale-[0.98] ${activeSection === 'mcp' ? 'bg-ops-green/15 text-ops-green shadow-glow border border-ops-green/30' : 'text-ops-muted hover:text-ops-text hover:bg-ops-panel/60 border border-transparent'}`} onClick={() => setActiveSection('mcp')}>{t('settings.mcp')}</button>
            <button type="button" className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 text-[11px] font-bold  active:scale-[0.98] ${activeSection === 'scheduler' ? 'bg-ops-green/15 text-ops-green shadow-glow border border-ops-green/30' : 'text-ops-muted hover:text-ops-text hover:bg-ops-panel/60 border border-transparent'}`} onClick={() => setActiveSection('scheduler')}>{t('settings.scheduler')}</button>
          </nav>
          <div className="flex-1 p-6 overflow-y-auto bg-ops-panel/50 relative">
            {loadError ? <div className="p-4 mb-6 rounded-md bg-ops-danger/10 border border-ops-danger/20 text-ops-danger text-sm flex items-center justify-between">{loadError}<button type="button" className="px-3 py-1.5 rounded-md bg-ops-border/20 hover:bg-ops-border/30 transition-colors text-ops-text text-sm" onClick={() => void loadSettings()}>{t('common.retry')}</button></div> : null}
            {sectionError ? <div className="p-4 mb-6 rounded-md bg-ops-danger/10 border border-ops-danger/20 text-ops-danger text-sm flex items-center justify-between">{sectionError}</div> : null}
